...
<body>
    ...
    <br />
    <hr>
    <h1>Employee show under Department Dropdown Select</h1>
    ...
    <div class='addition' style="width:500px">
        <div class="myfields">
            <input type="text" class="price1">
            <input type="text" class="price2">
            <input type="text" class="sub" disabled>
        </div>
    </div>
    ...
    <script type='text/javascript'>
        $(document).ready(function() {
            ...
            $('.myfields').on('keyup', '.price2', function() {

                $(".price2").each(function(index, value) {
                    var price2 = $(this).val();

                    console.log("Price2:" + price2);
                    if (price2) {
                        var price1 = $('.price1').val();
                        // var curr_base_rate = $('#dis_curr_base_rate').val();
                        console.log("Price1:" + price1);
                        var subtotal = (parseFloat(price1) + parseFloat(price2));
            ...
            $('.add').click(function() {
                var appenddata =
                    "<div class='myfields' style='width:500px'><input type='text' class='price1'><input type='text'  class='price2'><input type='text' class='sub' disabled><button class='del'>Del</button></div>";
                //$(".addition").append(appenddata);
                $(appenddata).appendTo($('.addition'));
            });

            $('.addition').on('click', '.del', function() {
                $(this).parent().remove();
            });
            ...
            $(".t2").keyup(function() {
                total = parseInt($(".t1").val()) + parseInt($(".t2").val());
                $(".total").val(total);
            });
